...
В MVP не входят голосовой ввод/STT/VAD, RAG, auth, промышленная многопользовательская нагрузка и полноценный пользовательский экран выбора/настройки сценариев. Сценарный API и snapshot уже реализованы, но UI выбора остаётся следующей продуктовой итерацией.
